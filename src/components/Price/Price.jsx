...
const faqItemsData = [
  {
    ...
    answer:
      "You can cancel anytime from your account settings. After cancellation, you'll still have access until the end of your current billing period.",
  },
  {
    question: "Is my medical data secure with MediConnect?",
    answer:
      "Absolutely. We use bank-level encryption and comply with all healthcare privacy regulations (HIPAA, GDPR) to ensure your data remains completely secure and private.",
  },
  {
    question: "How quickly can I get a doctor consultation?",
    answer:
      "With our PLUS and Premium plans, you can typically connect with a healthcare professional within minutes. Basic users may experience longer wait times during peak hours.",
  },
  {
    question: "Can I upgrade or downgrade my plan?",
    answer:
      "Yes, you can change your plan at any time. When upgrading, you'll get immediate access to new features. Downgrades will take effect at your next billing cycle.",
  },
  {
    question: "Do you offer family plans?",
    answer:
      "Our Premium plan includes coverage for up to 4 family members. You can add family members through your account dashboard after subscription.",
  },
];
              ...
              {faqItemsData.map((item, index) => (
                <React.Fragment key={index}>
                  ...
                  <div
                    ...
                    style={{
                      maxHeight: activeFaqIndex === index ? "200px" : "0",
                    }}
                  >
                    <p>{item.answer}</p>
                  </div>
